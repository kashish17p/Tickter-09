  ...
  return (
    ...
    <nav className="flex justify-between items-center px-10 md:px-12 py-4  text-white shadow-md">
     ...
     <Image src='/logo.svg' alt="/logo" width={250} height={250}/>
       ...
       <div className="relative w-160 hidden md:block">
       ...
       <div className="hidden md:flex items-center space-x-5">
         <button className="bg-yellow-400 font-bold text-black px-8 py-2 rounded-lg">
           Create Event
         </button>
       </div>  
       ...
       {/* Icons */}
        <div className="hidden md:flex items-center gap-8">
         ...
         <div className="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center md:hidden">
          <Image src="/account_circle.svg" alt="Account Icon" width={24} height={24} />
         </div>
